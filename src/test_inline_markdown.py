...
class TestHTMLNode(unittest.TestCase):
    ...
    def test_split_links(self):
        node = TextNode(
            "This is text with an [to my site](https://nickorton.dev) and another [to my band site](https://nick-squared.com)",
            TextType.TEXT,
        )
        ...
        self.assertListEqual(
            [
                TextNode("This is text with an ", TextType.TEXT),
                TextNode("to my site", TextType.LINK, "https://nickorton.dev"),
                TextNode(" and another ", TextType.TEXT),
                TextNode(
                    "to my band site", TextType.LINK, "https://nick-squared.com"
                ),
            ],
            new_nodes,
        )

    def test_full_split_textnodes(self):
